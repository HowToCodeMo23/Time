...
app.post('/login', async (req, res) => {
    ...
    // Fehlerbehandlung für falsche Anmeldedaten
...
app.get('/export', async (req, res) => {
    ...
    if (req.session.user) {
        const result = await db.query(
            'SELECT employee.personalid, employee.username, times.startzeit, times.endzeit, times.last_updated, projects.projectname FROM TIMES INNER JOIN employee ON employee.personalid = times.e_id INNER JOIN projects ON projects.projectid = times.p_id'
        );
